...
#..............................................................................
    ...
    INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
    VALUES ('BM', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03')), 'Turista',  100.00, 6);     
    INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
    VALUES ('BM', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03')), 'Primera',  200.00, 7);     
    INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
    VALUES ('BM', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03')), 'Ejecutiva', 300.00, 6);    
...
#..............................................................................
    ...
    INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
    VALUES ('MB', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-06')), 'Turista',  100.00, 5);     
    INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
    VALUES ('MB', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-06')), 'Primera',  200.00, 6);     
    INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
    VALUES ('MB', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-06')), 'Ejecutiva', 300.00, 4);    
...
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Turista', 4); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Primera', 1); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Ejecutiva', 1);
 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('CB2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05'), 'Turista', 4); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('CB2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05'), 'Primera', 4); 


INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('BM', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03'), 'Turista', 3); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('BM', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03'), 'Primera', 2); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('BM', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03'), 'Ejecutiva', 2); 

INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('MB', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-06'), 'Turista', 1); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('MB', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-06'), 'Primera', 1); 
INSERT INTO asientos_reservados( vuelo, fecha, clase, cantidad) VALUES ('MB', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-06'), 'Ejecutiva', 0); 
...
# RESERVA_VUELO_CLASE
        ...
        # NUEVO! Reservas de BM - 201X-01-03 3 turista - 2 primera - 2 ejecutiva -
        ...
        # NUEVO! Reservas de MB  -201X-01-06 - 1 turista - 1 primera -
